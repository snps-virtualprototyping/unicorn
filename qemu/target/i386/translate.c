...
static void gen_op_mov_reg_v(DisasContext *s, MemOp ot, int reg, TCGv t0)
{
    ...
    case MO_8:
        ...
        break;
    case MO_16:
        tcg_gen_deposit_tl(tcg_ctx, cpu_regs[reg], cpu_regs[reg], t0, 0, 16);
        break;
    case MO_32:
        /* For x86_64, this sets the higher half of register to zero.
           For i386, this is equivalent to a mov. */
        tcg_gen_ext32u_tl(tcg_ctx, cpu_regs[reg], t0);
        break;
#ifdef TARGET_X86_64
    case MO_64:
        tcg_gen_mov_tl(tcg_ctx, cpu_regs[reg], t0);
        break;
#endif
    default:
        tcg_abort();
...
static inline void gen_op_add_reg_im(DisasContext *s, MemOp size, int reg, int32_t val)
{
    TCGContext *tcg_ctx = s->uc->tcg_ctx;
    TCGv *cpu_regs = tcg_ctx->cpu_regs;

    tcg_gen_addi_tl(tcg_ctx, s->tmp0, cpu_regs[reg], val);
...
static inline void gen_op_add_reg_T0(DisasContext *s, MemOp size, int reg)
{
    ...
    tcg_gen_add_tl(tcg_ctx, s->tmp0, cpu_regs[reg], s->T0);
    gen_op_mov_reg_v(s, size, reg, s->tmp0);
}
...
static TCGv gen_ext_tl(DisasContext *s, TCGv dst, TCGv src, MemOp size, bool sign)
{
    TCGContext *tcg_ctx = s->uc->tcg_ctx;
...
static void gen_extu(DisasContext *s, MemOp ot, TCGv reg)
{
    gen_ext_tl(s, reg, reg, ot, false);
}

static void gen_exts(DisasContext *s, MemOp ot, TCGv reg)
{
    gen_ext_tl(s, reg, reg, ot, true);
}

static inline void gen_op_jnz_ecx(DisasContext *s, MemOp size, TCGLabel *label1)
{
    TCGContext *tcg_ctx = s->uc->tcg_ctx;
    TCGv *cpu_regs = tcg_ctx->cpu_regs;

    tcg_gen_mov_tl(tcg_ctx, s->tmp0, cpu_regs[R_ECX]);
    gen_extu(s, size, s->tmp0);
    tcg_gen_brcondi_tl(tcg_ctx, TCG_COND_NE, s->tmp0, 0, label1);
}

static inline void gen_op_jz_ecx(DisasContext *s, MemOp size, TCGLabel *label1)
{
    TCGContext *tcg_ctx = s->uc->tcg_ctx;
    TCGv *cpu_regs = tcg_ctx->cpu_regs;
...
static void gen_helper_in_func(DisasContext *s, MemOp ot, TCGv v, TCGv_i32 n)
{
    TCGContext *tcg_ctx = s->uc->tcg_ctx;
...
static void gen_helper_out_func(DisasContext *s, MemOp ot, TCGv_i32 v, TCGv_i32 n)
{
    TCGContext *tcg_ctx = s->uc->tcg_ctx;
...
static void gen_op_update2_cc(DisasContext *s)
{
    ...
    tcg_gen_mov_tl(tcg_ctx, cpu_cc_src, s->T1);
    tcg_gen_mov_tl(tcg_ctx, cpu_cc_dst, s->T0);
}
...
static void gen_op_update3_cc(DisasContext *s, TCGv reg)
{
    ...
    tcg_gen_mov_tl(tcg_ctx, cpu_cc_src2, reg);
    tcg_gen_mov_tl(tcg_ctx, cpu_cc_src, s->T1);
    tcg_gen_mov_tl(tcg_ctx, cpu_cc_dst, s->T0);
}
...
static inline void gen_op_testl_T0_T1_cc(DisasContext *s)
{
    ...
    tcg_gen_and_tl(tcg_ctx, cpu_cc_dst, s->T0, s->T1);
}
...
static void gen_op_update_neg_cc(DisasContext *s)
{
    ...
    tcg_gen_mov_tl(tcg_ctx, cpu_cc_dst, s->T0);
    tcg_gen_neg_tl(tcg_ctx, cpu_cc_src, s->T0);
...
static CCPrepare gen_prepare_eflags_c(DisasContext *s, TCGv reg)
{
    ...
    case CC_OP_SUBB: case CC_OP_SUBW: case CC_OP_SUBL: case CC_OP_SUBQ:
        ...
        t1 = gen_ext_tl(s, s->tmp0, cpu_cc_src, size, false);
    ...
    case CC_OP_ADDB: case CC_OP_ADDW: case CC_OP_ADDL: case CC_OP_ADDQ:
        ...
        t1 = gen_ext_tl(s, s->tmp0, cpu_cc_src, size, false);
        t0 = gen_ext_tl(s, reg, cpu_cc_dst, size, false);
    add_sub:
    ...
    case CC_OP_BMILGB: case CC_OP_BMILGW: case CC_OP_BMILGL: case CC_OP_BMILGQ:
        ...
        t0 = gen_ext_tl(s, reg, cpu_cc_src, size, false);
    ...
    default:
        {
            ...
            TCGv t0 = gen_ext_tl(s, reg, cpu_cc_dst, size, true);
...
static CCPrepare gen_prepare_eflags_z(DisasContext *s, TCGv reg)
{
    ...
    default:
        {
            MemOp size = (s->cc_op - CC_OP_ADDB) & 3;
            TCGv t0 = gen_ext_tl(s, reg, cpu_cc_dst, size, false);
            return ccprepare_make(TCG_COND_EQ, t0, 0, 0, -1, false, false);
        }
    }
}
...
static CCPrepare gen_prepare_cc(DisasContext *s, int b, TCGv reg)
{
    ...
    case CC_OP_SUBB: case CC_OP_SUBW: case CC_OP_SUBL: case CC_OP_SUBQ:
        ...
        case JCC_BE:
            ...
            gen_extu(s, size, s->tmp4);
            t0 = gen_ext_tl(s, s->tmp0, cpu_cc_src, size, false);
            cc = ccprepare_make(TCG_COND_LEU, s->tmp4, t0, 0, -1, true, false);
            break;
        ...
        fast_jcc_l:
            tcg_gen_mov_tl(tcg_ctx, s->tmp4, s->cc_srcT);
            gen_exts(s, size, s->tmp4);
            t0 = gen_ext_tl(s, s->tmp0, cpu_cc_src, size, true);
            cc = ccprepare_make(cond, s->tmp4, t0, 0, -1, true, false);
            break;
...
static inline void gen_ins(DisasContext *s, MemOp ot)
{
    ...
    gen_helper_in_func(s, ot, s->T0, s->tmp2_i32);
    gen_op_st_v(s, ot, s->T0, s->A0);
    gen_op_movl_T0_Dshift(s, ot);
    gen_op_add_reg_T0(s, s->aflag, R_EDI);
...
static void gen_op(DisasContext *s, int op, MemOp ot, int d)
{
    ...
    case OP_ADCL:
        if (s->prefix & PREFIX_LOCK) {
            tcg_gen_add_tl(tcg_ctx, s->T0, s->tmp4, s->T1);
            tcg_gen_atomic_add_fetch_tl(tcg_ctx, s->T0, s->A0, s->T0,
                                        s->mem_index, ot | MO_LE);
        } else {
            tcg_gen_add_tl(tcg_ctx, s->T0, s->T0, s->T1);
            tcg_gen_add_tl(tcg_ctx, s->T0, s->T0, s->tmp4);
            gen_op_st_rm_T0_A0(s, ot, d);
        }
        gen_op_update3_cc(s, s->tmp4);
        set_cc_op(s, CC_OP_ADCB + ot);
        break;
    case OP_SBBL:
        if (s->prefix & PREFIX_LOCK) {
            tcg_gen_add_tl(tcg_ctx, s->T0, s->T1, s->tmp4);
            tcg_gen_neg_tl(tcg_ctx, s->T0, s->T0);
            tcg_gen_atomic_add_fetch_tl(tcg_ctx, s->T0, s->A0, s->T0,
                                        s->mem_index, ot | MO_LE);
        } else {
            tcg_gen_sub_tl(tcg_ctx, s->T0, s->T0, s->T1);
            tcg_gen_sub_tl(tcg_ctx, s->T0, s->T0, s->tmp4);
            gen_op_st_rm_T0_A0(s, ot, d);
        }
        gen_op_update3_cc(s, s->tmp4);
    ...
    case OP_ADDL:
        if (s->prefix & PREFIX_LOCK) {
            tcg_gen_atomic_add_fetch_tl(tcg_ctx, s->T0, s->A0, s->T1,
                                        s->mem_index, ot | MO_LE);
        } else {
            tcg_gen_add_tl(tcg_ctx, s->T0, s->T0, s->T1);
            gen_op_st_rm_T0_A0(s, ot, d);
    ...
    case OP_SUBL:
        if (s->prefix & PREFIX_LOCK) {
            tcg_gen_neg_tl(tcg_ctx, s->T0, s->T1);
            tcg_gen_atomic_fetch_add_tl(tcg_ctx, s->cc_srcT, s->A0, s->T0,
                                        s->mem_index, ot | MO_LE);
            tcg_gen_sub_tl(tcg_ctx, s->T0, s->cc_srcT, s->T1);
        } else {
            tcg_gen_mov_tl(tcg_ctx, s->cc_srcT, s->T0);
            tcg_gen_sub_tl(tcg_ctx, s->T0, s->T0, s->T1);
            gen_op_st_rm_T0_A0(s, ot, d);
        }
        gen_op_update2_cc(s);
    ...
    case OP_ANDL:
        if (s->prefix & PREFIX_LOCK) {
            tcg_gen_atomic_and_fetch_tl(tcg_ctx, s->T0, s->A0, s->T1,
                                        s->mem_index, ot | MO_LE);
        } else {
    ...
    case OP_ORL:
        if (s->prefix & PREFIX_LOCK) {
            tcg_gen_atomic_or_fetch_tl(tcg_ctx, s->T0, s->A0, s->T1,
                                       s->mem_index, ot | MO_LE);
        } else {
    ...
    case OP_XORL:
        if (s->prefix & PREFIX_LOCK) {
            tcg_gen_atomic_xor_fetch_tl(tcg_ctx, s->T0, s->A0, s->T1,
                                        s->mem_index, ot | MO_LE);
        } else {
    ...
    case OP_CMPL:
        tcg_gen_mov_tl(tcg_ctx, cpu_cc_src, s->T1);
        tcg_gen_mov_tl(tcg_ctx, s->cc_srcT, s->T0);
        tcg_gen_sub_tl(tcg_ctx, cpu_cc_dst, s->T0, s->T1);
        set_cc_op(s, CC_OP_SUBB + ot);
        break;
    }
}
                            ...
                            TCGv shm1, TCGv count, bool is_right)
{
    ...
    tcg_gen_movcond_i32(tcg_ctx, TCG_COND_NE, cpu_cc_op, s32, z32, s->tmp2_i32, oldop);
                            ...
                            int is_right, int is_arith)
{
    ...
    if (op2 != 0) {
        tcg_gen_mov_tl(tcg_ctx, cpu_cc_src, s->tmp4);
        tcg_gen_mov_tl(tcg_ctx, cpu_cc_dst, s->T0);
...
static void gen_rot_rm_T1(DisasContext *s, MemOp ot, int op1, int is_right)
{
    ...
    /* The value that was "rotated out" is now present at the other end
       ...
       currently dead.  */
    if (is_right) {
        tcg_gen_shri_tl(tcg_ctx, cpu_cc_src2, s->T0, mask - 1);
        tcg_gen_shri_tl(tcg_ctx, cpu_cc_dst, s->T0, mask);
        tcg_gen_andi_tl(tcg_ctx, cpu_cc_dst, cpu_cc_dst, 1);
    } else {
        tcg_gen_shri_tl(tcg_ctx, cpu_cc_src2, s->T0, mask);
        tcg_gen_andi_tl(tcg_ctx, cpu_cc_dst, s->T0, 1);
    }
...
static void gen_shifti(DisasContext *s, int op, MemOp ot, int d, int c)
{
    TCGContext *tcg_ctx = s->uc->tcg_ctx;
    ...
    default:
        ...
        tcg_gen_movi_tl(tcg_ctx, s->T1, c);
...
static TCGv gen_lea_modrm_1(DisasContext *s, AddressParts a)
{
    ...
    if (a.index >= 0) {
        if (a.scale == 0) {
            ...
            tcg_gen_shli_tl(tcg_ctx, s->A0, cpu_regs[a.index], a.scale);
            ea = s->A0;
        }
        if (a.base >= 0) {
            tcg_gen_add_tl(tcg_ctx, s->A0, ea, cpu_regs[a.base]);
            ea = s->A0;
        }
    } else if (a.base >= 0) {
        ea = cpu_regs[a.base];
...
static inline void gen_op_movl_seg_T0_vm(DisasContext *s, int seg_reg)
{
    ...
    tcg_gen_st32_tl(tcg_ctx, s->T0, tcg_ctx->cpu_env,
                    offsetof(CPUX86State,segs[seg_reg].selector));
    tcg_gen_shli_tl(tcg_ctx, cpu_seg_base[seg_reg], s->T0, 4);
}
...
static void gen_pusha(DisasContext *s)
{
    ...
    for (i = 0; i < 8; i++) {
        tcg_gen_addi_tl(tcg_ctx, s->A0, cpu_regs[R_ESP], (i - 8) * size);
...
static void gen_leave(DisasContext *s)
{
    ...
    tcg_gen_addi_tl(tcg_ctx, s->T1, cpu_regs[R_EBP], 1 << d_ot);
...
static inline void gen_ldq_env_A0(DisasContext *s, int offset)
{
    ...
    tcg_gen_qemu_ld_i64(s->uc, s->tmp1_i64, s->A0, s->mem_index, MO_LEQ);
...
static inline void gen_stq_env_A0(DisasContext *s, int offset)
{
    ...
    tcg_gen_qemu_st_i64(s->uc, s->tmp1_i64, s->A0, s->mem_index, MO_LEQ);
}
...
static inline void gen_sto_env_A0(DisasContext *s, int offset)
{
    ...
    tcg_gen_qemu_st_i64(s->uc, s->tmp1_i64, s->A0, mem_index, MO_LEQ);
    tcg_gen_addi_tl(tcg_ctx, s->tmp0, s->A0, 8);
    tcg_gen_ld_i64(tcg_ctx, s->tmp1_i64, tcg_ctx->cpu_env, offset + offsetof(ZMMReg, ZMM_Q(1)));
    tcg_gen_qemu_st_i64(s->uc, s->tmp1_i64, s->tmp0, mem_index, MO_LEQ);
}
...
static inline void gen_op_movo(DisasContext *s, int d_offset, int s_offset)
{
    ...
    tcg_gen_ld_i64(tcg_ctx, s->tmp1_i64, tcg_ctx->cpu_env, s_offset + 8);
    tcg_gen_st_i64(tcg_ctx, s->tmp1_i64, tcg_ctx->cpu_env, d_offset + 8);
}
    ...
    if (sse_fn_epp == SSE_SPECIAL) {
        ...
        case 0x32b: /* movntsd */
            ...
            if (b1 & 1) {
                ...
                tcg_gen_ld32u_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State,
        ...
        case 0x6e: /* movd mm, ea */
            ...
            if (s->dflag == MO_64) {
                ...
                tcg_gen_st_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State,fpregs[reg].mmx));
            } else
#endif
            {
                gen_ldst_modrm(env, s, modrm, MO_32, OR_TMP0, 0);
                tcg_gen_addi_ptr(tcg_ctx, s->ptr0, cpu_env,
        ...
        case 0x6f: /* movq mm, ea */
            if (mod != 3) {
                ...
                rm = (modrm & 7);
                tcg_gen_ld_i64(tcg_ctx, s->tmp1_i64, cpu_env,
                               offsetof(CPUX86State,fpregs[rm].mmx));
                tcg_gen_st_i64(tcg_ctx, s->tmp1_i64, cpu_env,
                               offsetof(CPUX86State,fpregs[reg].mmx));
            }
            break;
        case 0x010: /* movups */
        ...
        case 0x210: /* movss xmm, ea */
            if (mod != 3) {
                ...
                tcg_gen_st32_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State,xmm_regs[reg].ZMM_L(0)));
                tcg_gen_movi_tl(tcg_ctx, s->T0, 0);
                tcg_gen_st32_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State,xmm_regs[reg].ZMM_L(1)));
                tcg_gen_st32_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State,xmm_regs[reg].ZMM_L(2)));
                tcg_gen_st32_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State,xmm_regs[reg].ZMM_L(3)));
            } else {
                rm = (modrm & 7) | REX_B(s);
        ...
        case 0x378:
            {
                ...
                tcg_gen_addi_ptr(tcg_ctx, s->ptr0, cpu_env,
                    offsetof(CPUX86State,xmm_regs[reg]));
                if (b1 == 1)
                    gen_helper_extrq_i(tcg_ctx, cpu_env, s->ptr0,
                                       tcg_const_i32(tcg_ctx, bit_index),
                                       tcg_const_i32(tcg_ctx, field_length));
                else
                    gen_helper_insertq_i(tcg_ctx, cpu_env, s->ptr0,
                                         tcg_const_i32(tcg_ctx, bit_index),
                                         tcg_const_i32(tcg_ctx, field_length));
            }
            break;
...
#ifdef TARGET_X86_64
            if (s->dflag == MO_64) {
                tcg_gen_ld_i64(tcg_ctx, s->T0, cpu_env,
                               offsetof(CPUX86State,fpregs[reg].mmx));
        ...
        case 0x211: /* movss ea, xmm */
            if (mod != 3) {
                gen_lea_modrm(env, s, modrm);
                tcg_gen_ld32u_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State,xmm_regs[reg].ZMM_L(0)));
                gen_op_st_v(s, MO_32, s->T0, s->A0);
            } else {
                rm = (modrm & 7) | REX_B(s);
        ...
        case 0x173:
            ...
            if (is_xmm) {
                ...
                tcg_gen_st32_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State,xmm_t0.ZMM_L(0)));
                tcg_gen_movi_tl(tcg_ctx, s->T0, 0);
                tcg_gen_st32_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State,xmm_t0.ZMM_L(1)));
                op1_offset = offsetof(CPUX86State,xmm_t0);
            } else {
                tcg_gen_movi_tl(tcg_ctx, s->T0, val);
                tcg_gen_st32_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State,mmx_t0.MMX_L(0)));
                tcg_gen_movi_tl(tcg_ctx, s->T0, 0);
                tcg_gen_st32_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State,mmx_t0.MMX_L(1)));
        ...
        case 0x050: /* movmskps */
            ...
            tcg_gen_addi_ptr(tcg_ctx, s->ptr0, cpu_env,
                             offsetof(CPUX86State,xmm_regs[rm]));
            gen_helper_movmskps(tcg_ctx, s->tmp2_i32, cpu_env, s->ptr0);
        ...
        case 0x150: /* movmskpd */
            ...
            tcg_gen_addi_ptr(tcg_ctx, s->ptr0, cpu_env,
                             offsetof(CPUX86State,xmm_regs[rm]));
            gen_helper_movmskpd(tcg_ctx, s->tmp2_i32, cpu_env, s->ptr0);
            tcg_gen_extu_i32_tl(tcg_ctx, cpu_regs[reg], s->tmp2_i32);
            break;
        case 0x02a: /* cvtpi2ps */
        case 0x12a: /* cvtpi2pd */
        ...
        case 0x32a: /* cvtsi2sd */
            ...
            if (ot == MO_32) {
                ...
                tcg_gen_trunc_tl_i32(tcg_ctx, s->tmp2_i32, s->T0);
                sse_fn_epi(tcg_ctx, cpu_env, s->ptr0, s->tmp2_i32);
            } else {
#ifdef TARGET_X86_64
                SSEFunc_0_epl sse_fn_epl = sse_op_table3aq[(b >> 8) & 1];
                sse_fn_epl(tcg_ctx, cpu_env, s->ptr0, s->T0);
#else
                goto illegal_op;
#endif
            }
        ...
        case 0x32d: /* cvtsd2si */
            ...
            if (ot == MO_32) {
                ...
                sse_fn_i_ep(tcg_ctx, s->tmp2_i32, cpu_env, s->ptr0);
                tcg_gen_extu_i32_tl(tcg_ctx, s->T0, s->tmp2_i32);
            } else {
#ifdef TARGET_X86_64
                SSEFunc_l_ep sse_fn_l_ep =
                    sse_op_table3bq[((b >> 7) & 2) | (b & 1)];
                sse_fn_l_ep(tcg_ctx, s->T0, cpu_env, s->ptr0);
#else
                goto illegal_op;
#endif
            }
        ...
        case 0x1c4:
            ...
            if (b1) {
                val &= 7;
                tcg_gen_st16_tl(tcg_ctx, s->T0, cpu_env,
        ...
        case 0x1c5:
            ...
            if (b1) {
                val &= 7;
                rm = (modrm & 7) | REX_B(s);
                tcg_gen_ld16u_tl(tcg_ctx, s->T0, cpu_env,
        ...
        case 0x1d7:
            ...
            if (b1) {
                rm = (modrm & 7) | REX_B(s);
                tcg_gen_addi_ptr(tcg_ctx, s->ptr0, cpu_env, offsetof(CPUX86State,xmm_regs[rm]));
                gen_helper_pmovmskb_xmm(tcg_ctx, s->tmp2_i32, cpu_env, s->ptr0);
            } else {
                rm = (modrm & 7);
                tcg_gen_addi_ptr(tcg_ctx, s->ptr0, cpu_env, offsetof(CPUX86State,fpregs[rm].mmx));
                gen_helper_pmovmskb_mmx(tcg_ctx, s->tmp2_i32, cpu_env, s->ptr0);
            }
            reg = ((modrm >> 3) & 7) | rex_r;
            tcg_gen_extu_i32_tl(tcg_ctx, cpu_regs[reg], s->tmp2_i32);
            break;
            ...
            if (b1) {
                ...
                if (mod == 3) {
                    ...
                    case 0x24: case 0x34: /* pmovsxwq, pmovzxwq */
                        tcg_gen_qemu_ld_i32(s->uc, s->tmp2_i32, s->A0,
                                            s->mem_index, MO_LEUL);
                        tcg_gen_st_i32(tcg_ctx, s->tmp2_i32, cpu_env, op2_offset +
                                        offsetof(ZMMReg, ZMM_L(0)));
                        break;
                    case 0x22: case 0x32: /* pmovsxbq, pmovzxbq */
                        tcg_gen_qemu_ld_tl(s->uc, s->tmp0, s->A0,
                                           s->mem_index, MO_LEUW);
                        tcg_gen_st16_tl(tcg_ctx, s->tmp0, cpu_env, op2_offset +
        ...
        do_0f_38_fx:
            ...
            do_crc32:
                ...
                tcg_gen_trunc_tl_i32(tcg_ctx, s->tmp2_i32, cpu_regs[reg]);
                gen_ldst_modrm(env, s, modrm, ot, OR_TMP0, 0);
            ...
            case 0x0f1: /* movbe My,Gy */
                ...
                gen_lea_modrm(env, s, modrm);
                if ((b & 1) == 0) {
                    tcg_gen_qemu_ld_tl(s->uc, s->T0, s->A0,
                                       s->mem_index, ot | MO_BE);
                    gen_op_mov_reg_v(s, ot, reg, s->T0);
                } else {
                    tcg_gen_qemu_st_tl(s->uc, cpu_regs[reg], s->A0,
                                       s->mem_index, ot | MO_BE);
                }
                break;
            ...
            case 0x0f2: /* andn Gy, By, Ey */
                ...
                ot = mo_64_32(s->dflag);
                gen_ldst_modrm(env, s, modrm, ot, OR_TMP0, 0);
                tcg_gen_andc_tl(tcg_ctx, s->T0, s->T0, cpu_regs[s->vex_v]);
                gen_op_mov_reg_v(s, ot, reg, s->T0);
                gen_op_update1_cc(s);
                set_cc_op(s, CC_OP_LOGICB + ot);
                break;
            ...
            case 0x0f7: /* bextr Gy, Ey, By */
                ...
                ot = mo_64_32(s->dflag);
                {
                    ...
                    tcg_gen_ext8u_tl(tcg_ctx, s->A0, cpu_regs[s->vex_v]);
                    ...
                    tcg_gen_extract_tl(tcg_ctx, s->A0, cpu_regs[s->vex_v], 8, 8);
            ...
            case 0x0f5: /* bzhi Gy, Ey, By */
                ...
                ot = mo_64_32(s->dflag);
                gen_ldst_modrm(env, s, modrm, ot, OR_TMP0, 0);
                tcg_gen_ext8u_tl(tcg_ctx, s->T1, cpu_regs[s->vex_v]);
                {
            ...
            case 0x3f6: /* mulx By, Gy, rdx, Ey */
                ...
                case MO_64:
                    tcg_gen_mulu2_i64(tcg_ctx, s->T0, s->T1,
                                       s->T0, cpu_regs[R_EDX]);
                    tcg_gen_mov_i64(tcg_ctx, cpu_regs[s->vex_v], s->T0);
                    tcg_gen_mov_i64(tcg_ctx, cpu_regs[reg], s->T1);
                    break;
#endif
                }
                break;
            ...
            case 0x2f6: /* adox Gy, Ey */
                if (!(s->cpuid_7_0_ebx_features & CPUID_7_0_EBX_ADX)) {
                    ...
                    case MO_32:
                        ...
                        tcg_gen_add_i64(tcg_ctx, s->T0, s->T0, cpu_regs[reg]);
                        tcg_gen_add_i64(tcg_ctx, s->T0, s->T0, carry_in);
                        tcg_gen_ext32u_i64(tcg_ctx, cpu_regs[reg], s->T0);
            ...
            case 0x3f7: /* shrx Gy, Ey, By */
                ...
                gen_ldst_modrm(env, s, modrm, ot, OR_TMP0, 0);
                if (ot == MO_64) {
                    tcg_gen_andi_tl(tcg_ctx, s->T1, cpu_regs[s->vex_v], 63);
                } else {
                    tcg_gen_andi_tl(tcg_ctx, s->T1, cpu_regs[s->vex_v], 31);
                }
                if (b == 0x1f7) {
                    tcg_gen_shl_tl(tcg_ctx, s->T0, s->T0, s->T1);
                } else if (b == 0x2f7) {
            ...
            case 0x3f3: /* Group 17 */
                ...
                tcg_gen_mov_tl(tcg_ctx, cpu_cc_src, s->T0);
                switch (reg & 7) {
                case 1: /* blsr By,Ey */
        ...
        case 0x13a:
            ...
            if (sse_fn_eppi == SSE_SPECIAL) {
                ...
                switch (b) {
                case 0x14: /* pextrb */
                    tcg_gen_ld8u_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State,
                                            xmm_regs[reg].ZMM_B(val & 15)));
                    if (mod == 3) {
                        gen_op_mov_reg_v(s, ot, rm, s->T0);
                    } else {
                        tcg_gen_qemu_st_tl(s->uc, s->T0, s->A0,
                                           s->mem_index, MO_UB);
                    }
                    break;
                case 0x15: /* pextrw */
                    tcg_gen_ld16u_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State,
                ...
                case 0x16:
                    if (ot == MO_32) { /* pextrd */
                        ...
                        if (mod == 3) {
                            tcg_gen_extu_i32_tl(tcg_ctx, cpu_regs[rm], s->tmp2_i32);
                        } else {
                            tcg_gen_qemu_st_i32(s->uc, s->tmp2_i32, s->A0,
                                                s->mem_index, MO_LEUL);
                        }
                    } else { /* pextrq */
#ifdef TARGET_X86_64
                        ...
                        if (mod == 3) {
                            tcg_gen_mov_i64(tcg_ctx, cpu_regs[rm], s->tmp1_i64);
                        } else {
                            tcg_gen_qemu_st_i64(s->uc, s->tmp1_i64, s->A0,
                                                s->mem_index, MO_LEQ);
                        }
#else
                        goto illegal_op;
                ...
                case 0x20: /* pinsrb */
                    ...
                    tcg_gen_st8_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State,
                                            xmm_regs[reg].ZMM_B(val & 15)));
                    break;
                case 0x21: /* insertps */
                    if (mod == 3) {
                    ...
                    tcg_gen_st_i32(tcg_ctx, s->tmp2_i32, cpu_env,
                                    offsetof(CPUX86State,xmm_regs[reg]
                                            .ZMM_L((val >> 4) & 3)));
                    if ((val >> 0) & 1)
                ...
                case 0x22:
                    if (ot == MO_32) { /* pinsrd */
                        ...
                        if (mod == 3) {
                            ...
                            tcg_gen_qemu_ld_i64(s->uc, s->tmp1_i64, s->A0,
                                                s->mem_index, MO_LEQ);
                        }
                        tcg_gen_st_i64(tcg_ctx, s->tmp1_i64, cpu_env,
                                        offsetof(CPUX86State,
        ...
        if (is_xmm) {
            ...
            if (mod != 3) {
                ...
                case 2:
                    /* 32 bit access */
                    gen_op_ld_v(s, MO_32, s->T0, s->A0);
                    tcg_gen_st32_tl(tcg_ctx, s->T0, cpu_env,
        ...
        case 0xf7:
            ...
            if (mod != 3)
                goto illegal_op;
            tcg_gen_mov_tl(tcg_ctx, s->A0, cpu_regs[R_EDI]);
            gen_extu(s, s->aflag, s->A0);
            gen_add_A0_ds_seg(s);
...
static void sync_eflags(DisasContext *s)
{
    ...
    tcg_gen_st_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State, eflags));
}
...
static void restore_eflags(DisasContext *s)
{
    ...
    tcg_gen_ld_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State, eflags));
    gen_helper_write_eflags(tcg_ctx, cpu_env, s->T0,
...
static target_ulong disas_insn(DisasContext *s, CPUState *cpu)
{
    ...
    if (HOOK_EXISTS_BOUNDED(env->uc, UC_HOOK_CODE, pc_start)) {
        ...
        // Unicorn: We get the address of the TCGOp *before* the tracecode operation
        //          as we'll need to patch it again further down with the proper size
        //          (as opposed to saying we have an instruction 0xF1F1F1F1 in size).
        //
        //          This is necessary as the TCGOps are stored within a tail queue,
        //          and so, we can't simply retrieve the op in particular after we've
        //          generated it, as a tail queue doesn't allow that behavior.
        //
        //          Within gen_uc_tracecode(), the first thing that occurs is the following:
        //
        //              TCGv_i32 tsize = tcg_const_i32(tcg_ctx, size);
        //
        //          This is the instruction size that we want to patch later on.
        //          tcg_const_i32 is as follows:
        //
        //              TCGv_i32 t0 = tcg_temp_new_i32(s);
        //              tcg_gen_movi_i32(s, t0, val);
        //              return t0;
        //
        //          And so the op *following the pre_hook_code_op* will be the move
        //          instruction that we want to patch with the correct size, which
        //          as stated, is done further down in the function.
        //
        pre_hook_code_op = tcg_last_op(tcg_ctx);
 ...
 reswitch:
    ...
    case 0xf7:
        ...
        case 4: /* mul */
            ...
            case MO_8:
                ...
                tcg_gen_mov_tl(tcg_ctx, cpu_cc_dst, s->T0);
                tcg_gen_andi_tl(tcg_ctx, cpu_cc_src, s->T0, 0xff00);
        ...
        case 6: /* div */
            switch(ot) {
            case MO_8:
                gen_helper_divb_AL(tcg_ctx, cpu_env, s->T0);
                break;
            case MO_16:
                gen_helper_divw_AX(tcg_ctx, cpu_env, s->T0);
                break;
            default:
            case MO_32:
                gen_helper_divl_EAX(tcg_ctx, cpu_env, s->T0);
                break;
#ifdef TARGET_X86_64
            case MO_64:
                gen_helper_divq_EAX(tcg_ctx, cpu_env, s->T0);
                break;
#endif
            }
            break;
        case 7: /* idiv */
            switch(ot) {
            case MO_8:
                gen_helper_idivb_AL(tcg_ctx, cpu_env, s->T0);
                break;
            case MO_16:
                gen_helper_idivw_AX(tcg_ctx, cpu_env, s->T0);
                break;
            default:
            case MO_32:
                gen_helper_idivl_EAX(tcg_ctx, cpu_env, s->T0);
                break;
#ifdef TARGET_X86_64
            case MO_64:
                gen_helper_idivq_EAX(tcg_ctx, cpu_env, s->T0);
                break;
#endif
            }
            break;
...
#ifdef TARGET_X86_64
        case MO_64:
            tcg_gen_muls2_i64(tcg_ctx, cpu_regs[reg], s->T1, s->T0, s->T1);
            tcg_gen_mov_tl(tcg_ctx, cpu_cc_dst, cpu_regs[reg]);
            tcg_gen_sari_tl(tcg_ctx, cpu_cc_src, cpu_cc_dst, 63);
            tcg_gen_sub_tl(tcg_ctx, cpu_cc_src, cpu_cc_src, s->T1);
            break;
#endif
        case MO_32:
            tcg_gen_trunc_tl_i32(tcg_ctx, s->tmp2_i32, s->T0);
    ...
    case 0xa3:
        ...
        break;
    case 0xd7: /* xlat */
        tcg_gen_mov_tl(tcg_ctx, s->A0, cpu_regs[R_EBX]);
        tcg_gen_ext8u_tl(tcg_ctx, s->T0, cpu_regs[R_EAX]);
        ...
        if (mod != 3) {
                ...
                (op >= 0x30 && op <= 0x37) )  /* fixxx */
            {
                    ...
                    case 0:
                        tcg_gen_qemu_ld_i32(s->uc, s->tmp2_i32, s->A0,
                                            s->mem_index, MO_LEUL);
                        gen_helper_flds_FT0(tcg_ctx, cpu_env, s->tmp2_i32);
                        break;
                    case 1:
                        tcg_gen_qemu_ld_i32(s->uc, s->tmp2_i32, s->A0,
                                            s->mem_index, MO_LEUL);
                        gen_helper_fildl_FT0(tcg_ctx, cpu_env, s->tmp2_i32);
                        break;
                    case 2:
                        tcg_gen_qemu_ld_i64(s->uc, s->tmp1_i64, s->A0,
                                            s->mem_index, MO_LEQ);
                        gen_helper_fldl_FT0(tcg_ctx, cpu_env, s->tmp1_i64);
                        break;
                    case 3:
                    default:
                        tcg_gen_qemu_ld_i32(s->uc, s->tmp2_i32, s->A0,
                    ...
                    (op >= 0x38 && op <= 0x3b) )  /* filds, fisttps, fists, fistps */
            {
                ...
                case 0:
                    ...
                    case 0:
                        tcg_gen_qemu_ld_i32(s->uc, s->tmp2_i32, s->A0,
                                            s->mem_index, MO_LEUL);
                        gen_helper_flds_ST0(tcg_ctx, cpu_env, s->tmp2_i32);
                        break;
                    case 1:
                        tcg_gen_qemu_ld_i32(s->uc, s->tmp2_i32, s->A0,
                                            s->mem_index, MO_LEUL);
                        gen_helper_fildl_ST0(tcg_ctx, cpu_env, s->tmp2_i32);
                        break;
                    case 2:
                        tcg_gen_qemu_ld_i64(s->uc, s->tmp1_i64, s->A0,
                                            s->mem_index, MO_LEQ);
                        gen_helper_fldl_ST0(tcg_ctx, cpu_env, s->tmp1_i64);
                        break;
                    case 3:
                    default:
                        tcg_gen_qemu_ld_i32(s->uc, s->tmp2_i32, s->A0,
                ...
                case 1:
                    ...
                    switch(op >> 4) {
                    case 1:
                        gen_helper_fisttl_ST0(tcg_ctx, s->tmp2_i32, cpu_env);
                        tcg_gen_qemu_st_i32(s->uc, s->tmp2_i32, s->A0,
                                            s->mem_index, MO_LEUL);
                        break;
                    case 2:
                        gen_helper_fisttll_ST0(tcg_ctx, s->tmp1_i64, cpu_env);
                        tcg_gen_qemu_st_i64(s->uc, s->tmp1_i64, s->A0,
                                            s->mem_index, MO_LEQ);
                        break;
                    case 3:
                    default:
                        gen_helper_fistt_ST0(tcg_ctx, s->tmp2_i32, cpu_env);
                        tcg_gen_qemu_st_i32(s->uc, s->tmp2_i32, s->A0,
                                            s->mem_index, MO_LEUW);
                        break;
                    }
                ...
                default:
                    switch(op >> 4) {
                    case 0:
                        gen_helper_fsts_ST0(tcg_ctx, s->tmp2_i32, cpu_env);
                        tcg_gen_qemu_st_i32(s->uc, s->tmp2_i32, s->A0,
                                            s->mem_index, MO_LEUL);
                        break;
                    case 1:
                        gen_helper_fistl_ST0(tcg_ctx, s->tmp2_i32, cpu_env);
                        tcg_gen_qemu_st_i32(s->uc, s->tmp2_i32, s->A0,
                                            s->mem_index, MO_LEUL);
                        break;
                    case 2:
                        gen_helper_fstl_ST0(tcg_ctx, s->tmp1_i64, cpu_env);
                        tcg_gen_qemu_st_i64(s->uc, s->tmp1_i64, s->A0,
                                            s->mem_index, MO_LEQ);
                        break;
                    case 3:
                    default:
                        gen_helper_fist_ST0(tcg_ctx, s->tmp2_i32, cpu_env);
                        tcg_gen_qemu_st_i32(s->uc, s->tmp2_i32, s->A0,
                                            s->mem_index, MO_LEUW);
                        break;
                    }
            ...
            {
                gen_helper_fldenv(tcg_ctx, cpu_env, s->A0, tcg_const_i32(tcg_ctx, dflag - 1));
            }
            else if(op == 0x0d) /* fldcw mem */
            {
                tcg_gen_qemu_ld_i32(s->uc, s->tmp2_i32, s->A0,
                                    s->mem_index, MO_LEUW);
                gen_helper_fldcw(tcg_ctx, cpu_env, s->tmp2_i32);
            }
            else if(op == 0x0e) /* fnstenv mem */
            {
                gen_helper_fstenv(tcg_ctx, cpu_env, s->A0, tcg_const_i32(tcg_ctx, dflag - 1));
            }
            else if(op == 0x0f) /* fnstcw mem */
            {
                gen_helper_fnstcw(tcg_ctx, s->tmp2_i32, cpu_env);
                tcg_gen_qemu_st_i32(s->uc, s->tmp2_i32, s->A0,
                                    s->mem_index, MO_LEUW);
            }
            else if(op == 0x1d) /* fldt mem */
            {
                gen_helper_fldt_ST0(tcg_ctx, cpu_env, s->A0);
            }
            else if(op == 0x1f) /* fstpt mem */
            {
                gen_helper_fstt_ST0(tcg_ctx, cpu_env, s->A0);
                gen_helper_fpop(tcg_ctx, cpu_env);
            }
            else if(op == 0x2c) /* frstor mem */
            {
                gen_helper_frstor(tcg_ctx, cpu_env, s->A0, tcg_const_i32(tcg_ctx, dflag - 1));
            }
            else if(op == 0x2e) /* fnsave mem */
            {
                gen_helper_fsave(tcg_ctx, cpu_env, s->A0, tcg_const_i32(tcg_ctx, dflag - 1));
            }
            ...
            {
                gen_helper_fbld_ST0(tcg_ctx, cpu_env, s->A0);
            }
            else if(op == 0x3e) /* fbstp */
            {
                gen_helper_fbst_ST0(tcg_ctx, cpu_env, s->A0);
                gen_helper_fpop(tcg_ctx, cpu_env);
            }
            else if(op == 0x3d) /* fildll */
            {
                tcg_gen_qemu_ld_i64(s->uc, s->tmp1_i64, s->A0, s->mem_index, MO_LEQ);
                gen_helper_fildll_ST0(tcg_ctx, cpu_env, s->tmp1_i64);
            }
            else if(op == 0x3f) /* fistpll */
            {
                gen_helper_fistll_ST0(tcg_ctx, s->tmp1_i64, cpu_env);
                tcg_gen_qemu_st_i64(s->uc, s->tmp1_i64, s->A0, s->mem_index, MO_LEQ);
                gen_helper_fpop(tcg_ctx, cpu_env);
            }
            else
    ...
    case 0x6d:
        ot = mo_b_d32(b, dflag);
        tcg_gen_ext16u_tl(tcg_ctx, s->T0, cpu_regs[R_EDX]);
    ...
    case 0xe5:
        ...
        gen_helper_in_func(s, ot, s->T1, s->tmp2_i32);
    ...
    case 0x9e: /* sahf */
        ...
        tcg_gen_or_tl(tcg_ctx, cpu_cc_src, cpu_cc_src, s->T0);
        break;
    case 0x9f: /* lahf */
        if (CODE64(s) && !(s->cpuid_ext3_features & CPUID_EXT3_LAHF_LM))
            goto illegal_op;
        ...
        tcg_gen_ori_tl(tcg_ctx, s->T0, cpu_cc_src, 0x02);
    ...
    case 0xfc: /* cld */
        ...
        tcg_gen_st_i32(tcg_ctx, s->tmp2_i32, cpu_env, offsetof(CPUX86State, df));
        break;
    case 0xfd: /* std */
        tcg_gen_movi_i32(tcg_ctx, s->tmp2_i32, -1);
        tcg_gen_st_i32(tcg_ctx, s->tmp2_i32, cpu_env, offsetof(CPUX86State, df));
    ...
    bt_op:
        ...
        default:
            ...
            gen_compute_eflags(s);
            tcg_gen_deposit_tl(tcg_ctx, cpu_cc_src, cpu_cc_src, s->tmp4,
                               ctz32(CC_C), 1);
            break;
        }
        break;
    ...
    case 0x1bd: /* bsr / lzcnt */
        ...
        if ((prefixes & PREFIX_REPZ)
            ...
            if (b & 1) {
                ...
                tcg_gen_xori_tl(tcg_ctx, s->T1, cpu_regs[reg], TARGET_LONG_BITS - 1);
    ...
    case 0x62: /* bound */
        ...
        tcg_gen_trunc_tl_i32(tcg_ctx, s->tmp2_i32, s->T0);
        if (ot == MO_16) {
            gen_helper_boundw(tcg_ctx, cpu_env, s->A0, s->tmp2_i32);
        } else {
            gen_helper_boundl(tcg_ctx, cpu_env, s->A0, s->tmp2_i32);
        }
        break;
    ...
    case 0x100:
        ...
        case 0: /* sldt */
            ...
            tcg_gen_ld32u_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State,ldt.selector));
            ot = mod == 3 ? dflag : MO_16;
            gen_ldst_modrm(env, s, modrm, ot, OR_TMP0, 1);
            break;
        case 2: /* lldt */
            ...
            if (s->cpl != 0) {
                ...
                gen_ldst_modrm(env, s, modrm, MO_16, OR_TMP0, 0);
                tcg_gen_trunc_tl_i32(tcg_ctx, s->tmp2_i32, s->T0);
                gen_helper_lldt(tcg_ctx, cpu_env, s->tmp2_i32);
            }
            break;
        case 1: /* str */
            if (!s->pe || s->vm86)
            ...
            tcg_gen_ld32u_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State,tr.selector));
            ot = mod == 3 ? dflag : MO_16;
            gen_ldst_modrm(env, s, modrm, ot, OR_TMP0, 1);
            break;
        case 3: /* ltr */
            ...
            if (s->cpl != 0) {
                ...
                gen_ldst_modrm(env, s, modrm, MO_16, OR_TMP0, 0);
                tcg_gen_trunc_tl_i32(tcg_ctx, s->tmp2_i32, s->T0);
                gen_helper_ltr(tcg_ctx, cpu_env, s->tmp2_i32);
            }
            break;
        case 4: /* verr */
        case 5: /* verw */
            ...
            gen_update_cc_op(s);
            if (op == 4) {
                gen_helper_verr(tcg_ctx, cpu_env, s->T0);
            } else {
                gen_helper_verw(tcg_ctx, cpu_env, s->T0);
            }
            set_cc_op(s, CC_OP_EFLAGS);
            break;
        default:
...
case 0x101:
        ...
        case 0xc8: /* monitor */
            ...
            gen_update_cc_op(s);
            gen_jmp_im(s, pc_start - s->cs_base);
            tcg_gen_mov_tl(tcg_ctx, s->A0, cpu_regs[R_EAX]);
            gen_extu(s, s->aflag, s->A0);
            gen_add_A0_ds_seg(s);
            gen_helper_monitor(tcg_ctx, cpu_env, s->A0);
            break;
        ...
        case 0xd0: /* xgetbv */
            ...
            gen_helper_xgetbv(tcg_ctx, s->tmp1_i64, cpu_env, s->tmp2_i32);
        ...
        case 0xd1: /* xsetbv */
            ...
            tcg_gen_concat_tl_i64(tcg_ctx, s->tmp1_i64, cpu_regs[R_EAX],
                                  cpu_regs[R_EDX]);
            tcg_gen_trunc_tl_i32(tcg_ctx, s->tmp2_i32, cpu_regs[R_ECX]);
            gen_helper_xsetbv(tcg_ctx, cpu_env, s->tmp2_i32, s->tmp1_i64);
        ...
        CASE_MODRM_MEM_OP(2): /* lgdt */
            ...
            tcg_gen_st_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State, gdt.base));
            tcg_gen_st32_tl(tcg_ctx, s->T1, cpu_env, offsetof(CPUX86State, gdt.limit));
            break;
        ...
        CASE_MODRM_MEM_OP(3): /* lidt */
            ...
            tcg_gen_st_tl(tcg_ctx, s->T0, cpu_env, offsetof(CPUX86State, idt.base));
            tcg_gen_st32_tl(tcg_ctx, s->T1, cpu_env, offsetof(CPUX86State, idt.limit));
            break;
        ...
        CASE_MODRM_OP(6): /* lmsw */
            ...
            gen_ldst_modrm(env, s, modrm, MO_16, OR_TMP0, 0);
            gen_helper_lmsw(tcg_ctx, cpu_env, s->T0);
            gen_jmp_im(s, s->pc - s->cs_base);
            gen_eob(s);
            break;
        ...
        CASE_MODRM_MEM_OP(7): /* invlpg */
            ...
            gen_jmp_im(s, pc_start - s->cs_base);
            gen_lea_modrm(env, s, modrm);
            gen_helper_invlpg(tcg_ctx, cpu_env, s->A0);
            gen_jmp_im(s, s->pc - s->cs_base);
            gen_eob(s);
            break;
        ...
        case 0xf8: /* swapgs */
            ...
            if (CODE64(s)) {
                if (s->cpl != 0) {
                    ...
                    tcg_gen_mov_tl(tcg_ctx, s->T0, cpu_seg_base[R_GS]);
                    tcg_gen_ld_tl(tcg_ctx, cpu_seg_base[R_GS], cpu_env,
                                  offsetof(CPUX86State, kernelgsbase));
                    tcg_gen_st_tl(tcg_ctx, s->T0, cpu_env,
                                  offsetof(CPUX86State, kernelgsbase));
                }
                break;
            }
    ...
    case 0x103: /* lsl */
        {
            ...
            gen_update_cc_op(s);
            if (b == 0x102) {
                gen_helper_lar(tcg_ctx, t0, cpu_env, s->T0);
            } else {
                gen_helper_lsl(tcg_ctx, t0, cpu_env, s->T0);
            }
            tcg_gen_andi_tl(tcg_ctx, s->tmp0, cpu_cc_src, CC_Z);
            label1 = gen_new_label(tcg_ctx);
            tcg_gen_brcondi_tl(tcg_ctx, TCG_COND_EQ, s->tmp0, 0, label1);
        ...
        if (s->flags & HF_MPX_EN_MASK) {
            ...
            if (prefixes & PREFIX_REPZ) {
                ...
                if (mod == 3) {
                    ...
                    gen_lea_modrm(env, s, modrm);
                    if (CODE64(s)) {
                        tcg_gen_qemu_ld_i64(s->uc, tcg_ctx->cpu_bndl[reg], s->A0,
                                            s->mem_index, MO_LEQ);
                        tcg_gen_addi_tl(tcg_ctx, s->A0, s->A0, 8);
                        tcg_gen_qemu_ld_i64(s->uc, tcg_ctx->cpu_bndu[reg], s->A0,
                                            s->mem_index, MO_LEQ);
                    } else {
                        tcg_gen_qemu_ld_i64(s->uc, tcg_ctx->cpu_bndl[reg], s->A0,
                                            s->mem_index, MO_LEUL);
                ...
                if (a.base >= 0) {
                    tcg_gen_addi_tl(tcg_ctx, s->A0, cpu_regs[a.base], a.disp);
                } else {
                    tcg_gen_movi_tl(tcg_ctx, s->A0, 0);
                }
                gen_lea_v_seg(s, s->aflag, s->A0, a.def_seg, s->override);
                if (a.index >= 0) {
                    tcg_gen_mov_tl(tcg_ctx, s->T0, cpu_regs[a.index]);
                } else {
                    tcg_gen_movi_tl(tcg_ctx, s->T0, 0);
                }
                if (CODE64(s)) {
                    gen_helper_bndldx64(tcg_ctx, tcg_ctx->cpu_bndl[reg], cpu_env, s->A0, s->T0);
                    tcg_gen_ld_i64(tcg_ctx, tcg_ctx->cpu_bndu[reg], cpu_env,
                                   offsetof(CPUX86State, mmx_t0.MMX_Q(0)));
                } else {
                    gen_helper_bndldx32(tcg_ctx, tcg_ctx->cpu_bndu[reg], cpu_env, s->A0, s->T0);
        ...
        if (s->flags & HF_MPX_EN_MASK) {
            ...
            if (mod != 3 && (prefixes & PREFIX_REPZ)) {
                ...
                if (mod == 3) {
                    ...
                    gen_lea_modrm(env, s, modrm);
                    if (CODE64(s)) {
                        tcg_gen_qemu_st_i64(s->uc, tcg_ctx->cpu_bndl[reg], s->A0,
                                            s->mem_index, MO_LEQ);
                        tcg_gen_addi_tl(tcg_ctx, s->A0, s->A0, 8);
                        tcg_gen_qemu_st_i64(s->uc, tcg_ctx->cpu_bndu[reg], s->A0,
                                            s->mem_index, MO_LEQ);
                    } else {
                        tcg_gen_qemu_st_i64(s->uc, tcg_ctx->cpu_bndl[reg], s->A0,
                                            s->mem_index, MO_LEUL);
                ...
                if (CODE64(s)) {
                    gen_helper_bndstx64(tcg_ctx, cpu_env, s->A0, s->T0,
                                        tcg_ctx->cpu_bndl[reg], tcg_ctx->cpu_bndu[reg]);
                } else {
                    gen_helper_bndstx32(tcg_ctx, cpu_env, s->A0, s->T0,
                                        tcg_ctx->cpu_bndl[reg], tcg_ctx->cpu_bndu[reg]);
                }
            }
        }
    ...
    case 0x1ae:
        ...
        CASE_MODRM_MEM_OP(2): /* ldmxcsr */
            ...
            gen_lea_modrm(env, s, modrm);
            tcg_gen_qemu_ld_i32(s->uc, s->tmp2_i32, s->A0, s->mem_index, MO_LEUL);
        ...
        case 0xdf: /* wrgsbase (f3 0f ae /3) */
            if (CODE64(s)
                ...
                gen_helper_cr4_testbit(tcg_ctx, cpu_env, s->tmp2_i32);
    ...
    if (pre_hook_code_op && HOOK_EXISTS_BOUNDED(env->uc, UC_HOOK_CODE, pc_start)) {
        // As explained further up in the function where pre_hook_code_op is
        ...
        TCGOp* const op = QTAILQ_NEXT(pre_hook_code_op, link);
        TCGArg* const args = op->args;
        args[1] = s->pc - pc_start;
    }
