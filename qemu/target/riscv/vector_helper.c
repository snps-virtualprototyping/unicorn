...
RVVCALL(OPIVV1, vfclass_v_h, OP_UU_H, H2, H2, fclass_h_risc)
RVVCALL(OPIVV1, vfclass_v_w, OP_UU_W, H4, H4, fclass_s_risc)
RVVCALL(OPIVV1, vfclass_v_d, OP_UU_D, H8, H8, fclass_d_risc)
