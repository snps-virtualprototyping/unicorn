                       ...
                       TCGArg a0, ...)
{
    ...
    v2 = temp_tcgv_vec(s, arg_temp(va_arg(va, TCGArg)));
    ...
    case INDEX_op_sarv_vec:
        ...
        tcg_gen_neg_vec(s, vece, t1, v2);
        opc = (opc == INDEX_op_shrv_vec
               ? INDEX_op_shlv_vec : INDEX_op_aa64_sshl_vec);
        vec_gen_3(s, opc, type, vece, tcgv_vec_arg(s, v0),
                  tcgv_vec_arg(s, v1), tcgv_vec_arg(s, t1));
